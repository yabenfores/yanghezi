...
public class GoodsGridAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.goods_gridview, parent, false);
		...
		ImageLoader.getInstance().displayImage(mGoods.getGoods_image(), holder.goods_gridview_image,
		...
		if (mGoods.getGoods_promotion_type() == 0) {
			holder.goods_discount.setText(df.format(discount) + "折");
		...
		holder.goods_content.setText(mGoods.getGoods_name());
	...
	class ViewHolder {
		...
		ImageView goods_gridview_image;
		...
		public ViewHolder(View convertView) {
			...
			this.goods_gridview_image = (ImageView) convertView.findViewById(R.id.goods_gridview_image);
			...
			this.goods_content = (TextView) convertView.findViewById(R.id.goods_content);
