...
public class EditAddressActivity extends BaseActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAddress != null) {
            is_default = mAddress.getIs_default() + "";
        }
    ...
    private void addAddress(String true_name, int area_id, int city_id, String area_info, String address,
        ...
        NetHelper.add_Address(true_name, area_id + "", city_id + "", area_info, address, tel_phone, is_default, mob_phone, new NetConnectionInterface.iConnectListener3() {
            @Override
            public void onStart() {
...
//		params.put("mob_phone", mob_phone);// 座机电话
        ...
        NetHelper.edit_Address(address_id + "", true_name, area_id + "", city_id + "", area_info, address, tel_phone, is_default, mob_phone, new NetConnectionInterface.iConnectListener3() {
            @Override
            public void onStart() {
