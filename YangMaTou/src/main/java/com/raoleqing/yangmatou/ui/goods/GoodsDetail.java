...
//                but_attention.setSelected(data.);
    ...
    private void setGoodsDesc(final String goods_desc) {
        ...
        if (goods_desc != null && !goods_desc.equals("")) {
            ...
            goods_detaile_webview.getSettings().setSupportZoom(false);// 支持缩放

            goods_detaile_webview.loadData(goods_desc, "text/html; charset=UTF-8", null);// 这种写法可以正确解码
        }
    }
...
//		params.put("uid", 1090);
        ...
        HttpUtil.post(GoodsDetail.this, HttpUtil.FAVORITES_SHOP_STORE, params, new JsonHttpResponseHandler() {
...
//		params.put("uid", 1090);
        ...
        HttpUtil.post(getAppContext(), HttpUtil.CANCEL_SHOP_STORE, params, new JsonHttpResponseHandler() {
