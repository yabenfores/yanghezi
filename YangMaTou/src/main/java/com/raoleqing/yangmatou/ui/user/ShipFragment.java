 ...
 *待发货
 * **/
public class ShipFragment extends Fragment implements OnClickListener{
...
*/
	...
	params.put("id", uid);
	params.put("state_type", 20);

	HttpUtil.post(getActivity(), HttpUtil.MEMBER_ORDER, params, new JsonHttpResponseHandler() {
